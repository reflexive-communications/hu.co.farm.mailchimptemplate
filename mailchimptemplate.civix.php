...
function _mailchimptemplate_civix_mixin_polyfill() {
...
function _mailchimptemplate_civix_civicrm_config(&$config = NULL) {
  ...
  _mailchimptemplate_civix_mixin_polyfill();
}
 ...
 */
function _mailchimptemplate_civix_civicrm_postInstall() {
  _mailchimptemplate_civix_civicrm_config();
  if ($upgrader = _mailchimptemplate_civix_upgrader()) {
 ...
 */
function _mailchimptemplate_civix_civicrm_entityTypes(&$entityTypes) {
